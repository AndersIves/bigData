...
//        List<String> lines = getStringsByTXT(txtFilePath, conf1, "");
        ...
        SparkConf conf = new SparkConf().setAppName("Spark Java API 学习")
                .setMaster("spark://192.168.217.132:7077");
        SparkSession sparkSession = SparkSession.builder().config(conf).getOrCreate();

        RDD<String> stringRDD = sparkSession.sparkContext().textFile("S:\\develop\\WorkSpace\\bigData\\recommendation\\src\\main\\resources\\movies.csv",1);
